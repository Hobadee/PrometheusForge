...
dev: doInstallDevelopment doInstallProduction
# dev: doInstallDevelopment doInstallProduction
...
doInstallDevelopment:
	$(CMD_PWSH) -c 'Install-Module Pester -Scope CurrentUser -Force;Install-Module -Name ModuleBuilder -Scope CurrentUser -Force'
