...
RequiredModules = @(
    @{
        ModuleName="powershell-yaml"; # Name of required module
        ModuleVersion="0.4.12"; # Minimum required version
        #GUID="" # GUID of required module
    }
)
...
# ScriptsToProcess = @('shared\global.ps1')

# Type files (.ps1xml) to be loaded when importing this module
# TypesToProcess = @()

# Format files (.ps1xml) to be loaded when importing this module
FormatsToProcess = @('Formats/LogEntry.format.ps1xml')
